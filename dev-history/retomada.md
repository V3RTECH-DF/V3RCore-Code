...
| V3RLicense | — (só visual) | 0.35.0 construída com **v0.6.0** (não v0.7.0, corrigido pela sessão v3rlicense-d3), instalada no dev-wp | Sessão reaberta (v3rlicense-d3). Subindo para v0.7.2 e regerando o ZIP; reinstalar só depois do ok desta sessão (dev-wp ocupado); remedir as 3 regressões contra o "antes" e liberar. Dados de teste no dev-wp: produto 81, licença 156, cliente 64 e `zz-temp-teste-64-aviso.php`. |
