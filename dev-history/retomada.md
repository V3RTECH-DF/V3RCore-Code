...
| RIT360 Solidário | 2.28.0 ✅ | planejando | Foto do "antes" visual (em curso ou a refazer). Plano da fatia 4 com a proposta de build (preferência: um `vite.config` por raiz; a página pública tem de sair byte a byte igual). Cor decidida pelo Bruno: `--v3r-accent: #24ae9c`, num ponto único. |
