...
| **Endereços antigos** | o endereço salvo de um submenu que deixou de existir continua funcionando — inclusive preservando parâmetros quando o destino é rota interna ou outra página do painel | 0.19.0 (slug de página do painel: 0.23.0) | V3RLGPD | `navegacao-do-painel.md` §7 |
